...
// Añade el avatar a nuestrop perfil
func SubirAvatar(w http.ResponseWriter, r *http.Request) {
	...
	var archivo string = "uploads/avatars/" + IDNegocio + "." + extension
	...
	var estado bool
	// le pasamos al avatar el id del negocio y la extension
	negocio.Avatar = IDNegocio + "." + extension
